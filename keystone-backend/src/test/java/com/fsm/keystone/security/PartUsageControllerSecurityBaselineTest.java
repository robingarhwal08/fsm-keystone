...
/**
 * Security baseline @WebMvcTest for {@link PartUsageController}.
 *
 * <p>{@code POST /api/part-usage} is {@code permitAll} with no {@code @PreAuthorize},
 * meaning anonymous actors can record part usage — an identified finding for the
 * default-deny hardening epic.</p>
 */
@WebMvcTest(PartUsageController.class)
...
class PartUsageControllerSecurityBaselineTest extends BaseControllerSecurityTest {
    ...
    @MethodSource("partUsageEndpointMatrix")
    ...
    static Stream<Arguments> partUsageEndpointMatrix() {
        return MatrixLoader.forController("PartUsageController")
